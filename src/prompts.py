...
def IMPLEMENT_METRIC_PROMPT(metric: str):
    return (
...
def EXPERIMENT_IMPLEMENTATION_PROMPT(slug: str) -> str:
    return f"""
...
def REPAIR_CODE_PROMPT(file_path: str, current_code: str, traceback: str) -> str:
    return f"""
...
IMPLEMENT_PREPROCESSING_CODE: str =  """
